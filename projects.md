  ...
  <div class="project-card-full">
    ...
    <div class="card-full-body">
      ...
      <div class="card-chips">
        ...
        <span class="chip">Flight Dynamics</span>
      </div>
    ...
    <div style="display: flex; flex: 1;">
      ...
      <div class="card-full-body">
        ...
        <ul class="card-bullets">
          <li>Led 30-member multidisciplinary team to MIT-WPU's first international aeromodelling competition. Won 'Outstanding Technical Presentation' and 3rd place Asia-Pacific.</li>
          <li>Designed fixed-wing aircraft carrying 7.5 kg payload. Oversaw all technical and non-technical departments.</li>
          <li>Raised USD 9,600 presenting to Cooper Corp. and Poonawalla Group.</li>
          <li>Spearheaded tandem-wing micro-class aircraft with 1.5 kg payload.</li>
          <li>Conducted SolidWorks workshop for 40 students, generating INR 40,000.</li>
        </ul>
        <div class="card-chips">
